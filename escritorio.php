...
<head>
    ...
    <meta name="keywords" content="escrit車rio de advocacia em belo horizonte, escrit車rios de advocacia em belo horizonte, advogados belo horizonte, advogado belo horizonte, advogado trabalhista bh whatsapp, advogados em belo horizonte,
        Escritorios, advogado bh, advogados online, advocacia, direito trabalhista, direito civil, civil direito, online, ">
    <title>Nogueira & Sarsur | Escrit車rio de Advocacia em Belo Horizonte</title>
...
<header id="header" style="background-image: url('./libraries/img/<?php echo $header_img; ?>');
     ...
     <div class="row" id="address">   
                   ...
                   <div class="collapse navbar-collapse" id="nav">
                       <ul class="navbar-nav mx-auto text-center">
                           <li class="nav-item active">
                               <a title="P芍gina Inicial" href="index.php" class="nav-link">Home</a>
                           </li>
                           <li class="nav-item">
                               <a title="Escrit車rio" href="escritorio.php" class="nav-link">Institucional</a>
                           </li>
                           <li class="nav-item">
                               <a title="" href="services.php" class="nav-link">Areas de Atuacao</a>
                           </li>
                           <li class="nav-item">
        ...
        <div class="row justify-content-center">
            <div class="text-center pb-5">
                ...
                <a href="../index.php" class="text-light">p芍gina inicial</a><i class="fa fa-chevron-right mx-2" style="color: white;"></i>
                <span class="text-light"> Nosso escrit車rio</span>
            </div>
        </div>
    </div>
</header>
