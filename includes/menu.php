       ...
       <div class="container-fluid" id="header"
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-white">
             <a class="navbar-brand" href="index.php">
             	<img alt="logo" src="./libraries/img/logo.jpg" class="w-50 img-fluid col-12">
             </a>
        ...
        <div class="mt-5 justify-content-center">
                    <h1 data-aos="fade-right" data-aos-duration="3000" style="color: #0c5460" 
                    class="font-weight-lighter py-5 text-center display-3">
                       <?php echo $texto2; ?></h1>
